/* 
 * This example shows how to control MDDS30 in Serial Packetized mode with Arduino.
 * Set MDDS30 input mode to 0b11100000
...
void loop()
{
  if (Serial.available()) { 
    delay(100);
    inChar = (char)Serial.read(); // シリアルモニターからの入力を読み込む
